- Dot files and directories in home folder are soft linked to the actual files in this
  repository. Run ~/dot-files/scripts/set_symlinks.py to set automatically.
...
- xorg files should go into /usr/share/X11/xorg.conf.d/ Make sure the prefix numbers
  are valid with respect to existing xorg.conf files.
